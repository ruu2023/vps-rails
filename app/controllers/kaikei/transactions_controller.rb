class Kaikei::TransactionsController < Kaikei::BaseController
  ...
  def new
    @transaction = current_user.kaikei_transactions.build(date: Date.current)
  ...
  def create
    ...
    if @transaction.save
      redirect_to kaikei_transactions_path, notice: "取引を登録しました"
    else
      load_form_collections
  ...
  def update
    if @transaction.update(transaction_params)
      redirect_to kaikei_transactions_path, notice: "取引を更新しました"
    else
      load_form_collections
  ...
  def destroy
    @transaction.destroy
    redirect_to kaikei_transactions_path, notice: "取引を削除しました"
  end
